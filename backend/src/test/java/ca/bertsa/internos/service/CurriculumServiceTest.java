...
import ca.bertsa.internos.exception.CurriculumAlreadyTreatedException;
import ca.bertsa.internos.exception.CurriculumUsedException;
...
import ca.bertsa.internos.repository.CurriculumRepository;
...
public class CurriculumServiceTest {
    ...
    public void testAllCurriculumsByStudentAsStudentCurriculumsDTO_withValidEntries() {
        ...
        Assertions.assertThat(actual.getCurriculumList()).isEqualTo(curriculumList);
        Assertions.assertThat(actual.getPrincipal()).isEqualTo(student.getPrincipalCurriculum());
    }
    ...
    public void testAllCurriculumsByStudentAsStudentCurriculumsDTO_withNoPrincipal() {
        ...
        Assertions.assertThat(actual.getCurriculumList()).isEqualTo(curriculumList);
        Assertions.assertThat(actual.getPrincipal()).isNull();
    }
