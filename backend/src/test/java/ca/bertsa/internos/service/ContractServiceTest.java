...
import ca.bertsa.internos.dto.ContractStarterDto;
import ca.bertsa.internos.dto.StudentMonitorOfferDTO;
import ca.bertsa.internos.enums.Status;
import ca.bertsa.internos.exception.*;
import ca.bertsa.internos.model.*;
import ca.bertsa.internos.repository.ContractRepository;
import ca.bertsa.internos.repository.StudentRepository;
...
public class ContractServiceTest {
    ...
    public void testBuildStudentMonitorOfferDTOFromContract_withValidEntries() {
        ...
        Assertions.assertThat(actual.getStudent()).isEqualTo(studentMonitorOfferDTO.getStudent());
        Assertions.assertThat(actual.getMonitor()).isEqualTo(studentMonitorOfferDTO.getMonitor());
        Assertions.assertThat(actual.getOffer()).isEqualTo(studentMonitorOfferDTO.getOffer());
    }
